...
<!-- IF POST_PM_URL --><div class="buttons"><div class="pmnew-button"><a href="{POST_PM_URL}"><span>{L_POST_PM}</span></a></div></div><!-- ENDIF -->
<br clear="all" />
...
<tr>
	<td align="left" valign="top"><!-- IF POST_PM_URL --><div class="buttons"><div class="pmnew-button"><a href="{POST_PM_URL}"><span>{L_POST_PM}</span></a></div></div><!-- ELSE -->&nbsp;<!-- ENDIF --></td>
