{IMG_THL}{IMG_THC}<span class="forumlink">{REG_TITLE}</span>{IMG_THR}<table class="forumlinenb">
<tr>
	<td class="row1" colspan="2">
		...
		<tr>
			...
			<!-- END reg_option2 -->
			<!-- BEGIN reg_option3 -->
			<td colspan="1" class="tw33pct row2"><input type="button" class="mainoption" value="{REG_OPTION3_NAME}" onclick="self.location.href='{REG_OPTION3_URL}';" onmouseover="'{REG_OPTION3_NAME}'" {REG_OPTION3_READONLY} />&nbsp;<span class="text_red">({REG_OPTION3_COUNT})</span>&nbsp;</td>
			<!-- END reg_option3 -->
		</tr>
		<tr>
			<!-- BEGIN reg_option1 -->
