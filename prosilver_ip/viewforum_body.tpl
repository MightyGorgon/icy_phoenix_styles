...
<tr><td align="left" valign="middle"><!-- IF not S_BOT --><div class="buttons"><!-- IF IS_LOCKED --><div class="locked-button"><!-- ELSE --><div class="newtopic-button"><!-- ENDIF --><a href="{U_POST_NEW_TOPIC}"><span>{L_POST_NEW_TOPIC}</span></a></div></div><!-- ELSE -->&nbsp;<!-- ENDIF --></td></tr>
</table>
{BOARD_INDEX}
...
<table class="empty-table" width="100%" cellspacing="0" cellpadding="0" border="0">
<tr>
	<td align="left" valign="top"><!-- IF not S_BOT --><div class="buttons"><!-- IF IS_LOCKED --><div class="locked-button"><!-- ELSE --><div class="newtopic-button"><!-- ENDIF --><a href="{U_POST_NEW_TOPIC}"><span>{L_POST_NEW_TOPIC}</span></a></div></div><!-- ELSE -->&nbsp;<!-- ENDIF --></td>
