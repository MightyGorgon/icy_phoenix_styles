...
<tr class="row1h{catrow.forumrow.LINK_CLASS} row-forum">
	...
	<!-- BEGIN forum_link_no -->
	<td class="row1 row-center" style="background: none;" width="120" colspan="2"{catrow.forumrow.LINKS_ROWSPAN}><div class="gensmall">{L_TOPICS}:&nbsp;{catrow.forumrow.TOPICS}<br />{L_POSTS}:&nbsp;{catrow.forumrow.POSTS}{catrow.forumrow.ONLINE}</div></td>
	<td class="row1 row-center" style="background: none;" width="180" nowrap="nowrap"{catrow.forumrow.LINKS_ROWSPAN}><span class="gensmall"><!-- IF S_BOT -->&nbsp;<!-- ELSE -->{catrow.forumrow.LAST_POST}<!-- ENDIF --></span></td>
	<!-- END forum_link_no -->
	<!-- BEGIN forum_link -->
	<td class="row1" style="background: none;" align="center" valign="middle" height="50" colspan="3"{catrow.forumrow.LINKS_ROWSPAN}><span class="gensmall">{catrow.forumrow.forum_link.HIT_COUNT}</span></td>
	<!-- END forum_link -->
</tr>
