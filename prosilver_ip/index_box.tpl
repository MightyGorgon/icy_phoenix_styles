...
<!-- BEGIN cathead -->
<tr>
	<!-- BEGIN inc --><td class="{catrow.cathead.inc.INC_CLASS} tw37px"><img src="{SPACER}" width="37" height="0" /></td><!-- END inc -->
...
<!-- END cathead -->
<tr>
	<th colspan="{catrow.tablehead.INC_SPAN} tdnw">&nbsp;{L_FORUM}&nbsp;</th>
	<th class="tw120px" colspan="2">&nbsp;{L_TOPICS}&nbsp;/&nbsp;{L_POSTS}&nbsp;</th>
	<th class="tw180px">&nbsp;{L_LASTPOST}&nbsp;</th>
</tr>
<!-- END tablehead -->
<?php
...
<tr class="row1h{catrow.forumrow.LINK_CLASS} row-forum">
	<!-- BEGIN inc --><td class="{catrow.forumrow.inc.INC_CLASS} tw37px"{catrow.forumrow.LINKS_ROWSPAN}><img src="{SPACER}" width="37" height="0" alt="" /></td><!-- END inc -->
	<td class="row1 tw37px" style="padding-left: 1px; padding-right: 3px; vertical-align: middle; min-height: 50px; background: none;" {catrow.forumrow.LINKS_ROWSPAN}>{catrow.forumrow.U_MARK_ALWAYS_READ}</td>
	<td class="row1" style="background: none; cursor: pointer;" colspan="{catrow.forumrow.INC_SPAN}" data-href="{catrow.forumrow.U_VIEWFORUM}">
		<table>
		<tr>
			<!-- BEGIN forum_icon -->
	...
	<!-- BEGIN forum_link_no -->
	<td class="row1 row-center tw120px" style="background: none;" colspan="2"{catrow.forumrow.LINKS_ROWSPAN}><div class="gensmall">{L_TOPICS}:&nbsp;{catrow.forumrow.TOPICS}<br />{L_POSTS}:&nbsp;{catrow.forumrow.POSTS}{catrow.forumrow.ONLINE}</div></td>
	<td class="row1 row-center tw180px" style="background: none;" nowrap="nowrap"{catrow.forumrow.LINKS_ROWSPAN}><span class="gensmall"><!-- IF S_BOT -->&nbsp;<!-- ELSE -->{catrow.forumrow.LAST_POST}<!-- ENDIF --></span></td>
	<!-- END forum_link_no -->
	<!-- BEGIN forum_link -->
	<td class="row1 tdalignc tvalignm th50px" style="background: none;" colspan="3"{catrow.forumrow.LINKS_ROWSPAN}><span class="gensmall">{catrow.forumrow.forum_link.HIT_COUNT}</span></td>
	<!-- END forum_link -->
</tr>
