...
<tr>
	...
	<td class="row1 row-center">&nbsp;<!-- BEGIN switch_mod_option --><input type="checkbox" name="members[]" value="{memberrow.USER_ID}" /><!-- END switch_mod_option -->&nbsp;</td>
</tr>
<!-- END memberrow -->
<!-- BEGIN switch_no_members -->
<tr><td class="row1 row-center" colspan="5">{L_NO_MEMBERS}</td></tr>
<!-- END switch_no_members -->
<!-- BEGIN switch_hidden_group -->
<tr><td class="row1 row-center" colspan="5">{L_HIDDEN_MEMBERS}</td></tr>
