...
<div width="100%" style="text-align: left; vertical-align: bottom; margin-top: 5px; margin-bottom: 3px;">
	...
	<!-- IF DL_UPLOAD_URL --><div class="buttons"><div class="upload-button"><a href="{DL_UPLOAD_URL}"><span>{DL_UPLOAD_LANG}</span></a></div></div><!-- ENDIF --><br /><br />
</div>
{SUBCAT_BOX}
<!-- BEGIN download_rows -->
...
<!-- END download_rows -->
<div class="gensmall" style="width: 100%; text-align: left;"><!-- IF U_SEARCH --><span style="float: right;">&nbsp;{U_SEARCH}</span><!-- ENDIF --><!-- BEGIN modcp --><span class="gensmall">{modcp.DL_MODCP}&nbsp;</span><!-- END modcp --><!-- BEGIN cat_traffic --><br />{cat_traffic.CAT_TRAFFIC}<!-- END cat_traffic --></div>
</form>
